...
def read_md5sums(md5_file: Optional[Path] = None, tag_name: Optional[str] = None, org_name: Optional[str] = None) -> dict:
...
if __name__ == "__main__":
    ...
    parser.add_argument("--org-name", type=str, default="NREL", help="Path to a md5sum.txt on disk, will download it from an existing release otherwise")
    ...
    cmake_mod_lines = create_new_cmakelists(cmake_lines=cmake_lines, md5sums=md5sums, tag_name=tag_name, org_name=org_name)
