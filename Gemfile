...
gem 'openstudio-extension', :github => 'NREL/openstudio-extension-gem', :ref => 'v0.5.0-alpha'
#gem 'openstudio-workflow', '= 2.3.0'
gem 'openstudio-workflow', :github => 'NREL/OpenStudio-workflow-gem', :ref => 'v2.3.0-alpha'
